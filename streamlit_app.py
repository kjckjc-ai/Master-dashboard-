...
st.set_page_config(page_title="Schools Dashboard", layout="wide")
...
# Trust Overview (imported later)
with tab1:
    st.markdown("### Trust Overview loading...")

# National View from uploaded app
with tab2:
